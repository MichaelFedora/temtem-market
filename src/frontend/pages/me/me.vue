...
<div id='tem-me'>
  <div
    id='header'
    :class='{
      "status-offline": me.status === "invisible",
      "status-online": me.status === "online",
      "status-in-game": me.status === "in_game"
    }'
  >
    <figure><img alt='avatar' :src='me.discordAvatar + "?size=256"'></figure>
    <div>
      ...
      <!-- tamer name & id -->
      <div class='temtem'>
        <span v-if='!editing' title='Tamer Info' class='title is-5'>{{ me.temUserName }} - {{ me.temUserID }}</span>
        <template v-else>
